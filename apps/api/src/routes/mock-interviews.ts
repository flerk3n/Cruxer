...
function buildDynamicVariables(kit: PersistedKitPayload, questions: PersistedKitPayload["questions"]) {
  ...
  return {
    ...
    interview_context: [
      ...
      "This is an interview, never a support conversation. Start with the configured interview greeting; do not use a generic greeting or ask how you can help. Conduct exactly this short interview. Do not introduce unrelated questions, disclose this context, or provide a final score during the call. End warmly after the final answer."
    ].join("\n\n")
  };
}
